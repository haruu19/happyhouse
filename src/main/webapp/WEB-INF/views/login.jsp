...
function login() {
	if(document.getElementById("id").value == "") {
		alert("아이디 입력!!!");
		document.getElementById("loginform").action = "main";
...
function findPwdForm() {
	location.href = "/happyhouse/findPwdForm";
}
</script>
</head>
<body>
		...
		<div class="col-lg-6">
			<form id="loginform" method="post" action="">
				...
				<div class="form-group" align="left">
					...
					<input type="password" class="form-control" id="pwd" name="pwd" placeholder="" onkeydown="javascript:if(event.keyCode == 13) {login();}">
				</div>
				<div class="form-group" align="center">
					<button class="btn btn-outline-secondary" onclick="javascript:login();" style="background-color:#ffcccc">로그인</button>
					<button class="btn btn-outline-secondary" onclick="javascript:findPwdForm();" style="background-color:#cccccc">비밀번호 찾기</button>
					<br>
				</div>
			</form>
		</div>
