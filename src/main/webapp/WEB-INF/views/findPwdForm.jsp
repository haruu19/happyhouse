...
function login() {
	if(document.getElementById("id").value == "") {
		...
		document.getElementById("findpwdform").action = "newPwdForm";
	...
	<div class="container" align="center">
		<div class="col-lg-6" align="center">
			...
			<input type="hidden" name="act" value="findpwd"> 
				...
				<div class="form-group" align="left">
					<label for="pwd">이름 <font color="red">*</font></label>
				...
				<div class="form-group" align="center">
					<button class="btn btn-warning" onclick="javascript:login();">비밀번호 찾기</button>
				</div>
			</form>
		</div>
	</div>
