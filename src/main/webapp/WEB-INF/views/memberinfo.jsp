...
function update() {
	$("#memberinfoBtn").attr("action","main").submit();
}
function updateform() {
	$("#memberinfoBtn").attr("action","updateForm").submit();
}
</script>
...
<body>
	...
	<div class="container" id="memberpage">
		<div id="memberinfo">
			<h1>회원 정보 확인</h1>
			<table class="table table-hover ">
				<tr>
					<td class="info-tag">아이디<font color="red">*</font></td>
					<td>${memberinfo.id}</td>
				</tr>
				<tr>
					<td class="info-tag">비밀번호<font color="red">*</font></td>
					<td>${memberinfo.pwd}</td>
				</tr>
				<tr>
					<td class="info-tag">이름<font color="red">*</font></td>
					<td>${memberinfo.name}</td>
				</tr>
				<tr>
					<td class="info-tag">주소<font color="red">*</font></td>
					<td>${memberinfo.email}</td>
				</tr>
				<tr>
					<td class="info-tag">전화번호<font color="red">*</font></td>
	...
	<div align="center">
	<form id="memberinfoBtn" method="get" action="">
		<button class="btn btn-primary" onclick="javascript:update();">확인</button>
		<button class="btn btn-warning" onclick="javascript:updateform();">수정</button>
	</form>
	</div>
