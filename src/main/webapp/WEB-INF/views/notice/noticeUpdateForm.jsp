...
$(document).ready(function() {
	$("#registerBtn").click(function() {
		...
		if($("#title").val() == "") {
			...
			$("#noticeform").attr("action", "updateNotice").submit();
		}
	});
});
</script>
...
<body>
	...
	<div class="container" align="center">
		<div class="col-lg-6" align="center">
			<form id="noticeform" method="get" action="updateNotice">
				<input type="hidden" name="isbn" id="isbn" value="${notice.isbn}">
				<div class="form-group" align="left">
					<label for="title">제 목 <font color="red">*</font></label>
					<input type="text" class="form-control" id="title" name="title" placeholder="" value="${notice.title}">
				</div>
				
				<div class="form-group" align="left">
					<label for="content">내 용 <font color="red">*</font></label>
					<input type="text" class="form-control" id="content" name="content" placeholder="" value="${notice.content}">
				</div>
				
				<div class="form-group" align="center">
					<button type="button" class="btn btn-outline-secondary" id="registerBtn" style="background-color:#ffcccc">확인</button>
					<button type="reset" class="btn btn-outline-secondary" style="background-color:#cccccc">초기화</button>
				</div>
			</form>
		</div>
	</div>
