        	...
        	<div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>평가 결과는 다음과 같습니다 :</h3>
                    </div>
                </div>
            </div>
            <div class="row">
            	<c:set var="store" value="${count.storeCnt}" /> 
            	<c:set var="env" value="${count.envCnt}" /> 
            	<c:set var="school" value="${count.schoolCnt}" /> 
            	<c:if test="${store>=10}">
            	<div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="/happyhouse/resources/img/A.JPG" alt="">
                        </div>
                        <h3>편의시설</h3>
                    </div>
                </div>
            	</c:if>
            	<c:if test="${store>=1&&store<10}">
            	<div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="/happyhouse/resources/img/B.JPG" alt="">
                        </div>
                        <h3>편의시설</h3>
                    </div>
                </div>
            	...
            	<div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="/happyhouse/resources/img/C.JPG" alt="">
                        </div>
                        <h3>편의시설</h3>
                    </div>
                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div>
                                            <img style="border-radius: 7px;" src="/happyhouse/resources/img/store2.JPG" alt="">
                                        </div>
                                        <p>해당 지역에 충분한 편의시설을 보유하고 있습니다.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div>
                                            <img style="border-radius: 7px;" src="/happyhouse/resources/img/env2.JPG" alt="">
                                        </div>
                                        <p>해당 지역의 녹지대 조성 수준이 매우 높습니다.</p>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div>
                                            <img style="border-radius: 7px;" src="/happyhouse/resources/img/school2.JPG" alt="">
                                        </div>
                                        <p>해당 지역의 교육 환경이 매우 좋습니다.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
