...
$(document).ready(function() {
	$("#updateBtn").click(function() {
		if($("#name").val() == "") {
			...
			$("#memberform").attr("action", "update").submit();
		}
	});
	...
	<div class="col-lg-6" align="center">
		...
		<input type="hidden" name="act" id="act" value="change">
			<div class="form-group" align="left">
				...
				<input type="text" class="form-control" id="id" name="id" placeholder="" value="${memberinfo.id}" readonly>
			</div>
			
			<div class="form-group" align="left">
				<label for="pwd">비밀번호 <font color="red">*</font></label>
				<input type="password" class="form-control" id="memberformPwd" name="pwd" placeholder="" value="${memberinfo.pwd}">
			</div>
			
			<div class="form-group" align="left">
				<label for="name">이름 <font color="red">*</font></label>
				<input type="text" class="form-control" id="name" name="name" placeholder="" value="${memberinfo.name}">
			</div>
			
			<div class="form-group" align="left">
				<label for="email">주소<font color="red">*</font></label><br>
				<input type="text" class="form-control" id="email" name="email" placeholder="" size="25" value="${memberinfo.email}">
			</div>
			
			<div class="form-group" align="left">
				<label for="phone">전화번호<font color="red">*</font></label>
				<input type="text" class="form-control" id="phone" name="phone" placeholder="" value="${memberinfo.phone}">
			</div>
